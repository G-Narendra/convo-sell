...
But the problem with this tool is that can often give us made up things especially if there is nothing that is there to give this tool information about our cafe. so that it does not make up stuff for the customers I added a section to the program where i stored the all the information about the Menu Items so that the smart brain can look up the dish and come and give answers based on the menu items and the customers needs such as the allergies or ingreedients they do not want in their food etc. 
